...
function makeCoreRequests({ fetch, logger: defaultLogger } = {}) {
    ...
    async function updateIfScm({ settings, logger = mainLogger, }) {
        ...
        if (utils.types.isString(result) || (result === null || result === void 0 ? void 0 : result.status) === 401) {
            throw new missingApiKeyError_1.MissingApiKeyError(); // TODO: server should return 401 when missing API key
        }
